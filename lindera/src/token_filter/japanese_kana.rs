...
mod tests {
    ...
    fn test_japanese_kana_token_filter_apply_hiragana_to_katakana_ipadic() {
        ...
        let mut tokens: Vec<Token> = vec![
            Token::new("埼玉", 0, 6, 0, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "固有名詞".to_string(),
                    "地域".to_string(),
                ...
                .clone(),
            Token::new("県", 6, 9, 1, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "接尾".to_string(),
                    "地域".to_string(),
                ...
                .clone(),
            Token::new("さいたま", 9, 21, 2, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "固有名詞".to_string(),
                    "一般".to_string(),
                ...
                .clone(),
            Token::new("市", 21, 24, 3, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "接尾".to_string(),
                    "地域".to_string(),
    ...
    fn test_japanese_kana_token_filter_apply_hiragana_to_katakana2_ipadic() {
        ...
        let mut tokens: Vec<Token> = vec![
            Token::new("東京", 0, 6, 1, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "固有名詞".to_string(),
                    "地域".to_string(),
                ...
                .clone(),
            Token::new("都", 6, 9, 2, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "接尾".to_string(),
                    "地域".to_string(),
                ...
                .clone(),
            Token::new("あきる野", 9, 21, 3, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "固有名詞".to_string(),
                    "地域".to_string(),
                ...
                .clone(),
            Token::new("市", 21, 24, 4, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "接尾".to_string(),
                    "地域".to_string(),
    ...
    fn test_japanese_kana_token_filter_apply_katakana_to_hiragana2_ipadic() {
        ...
        let mut tokens: Vec<Token> = vec![
            Token::new("南北線", 0, 9, 0, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "固有名詞".to_string(),
                    "一般".to_string(),
                ...
                .clone(),
            Token::new("四ツ谷", 9, 18, 1, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "固有名詞".to_string(),
                    "地域".to_string(),
                ...
                .clone(),
            Token::new("駅", 18, 21, 2, WordId::default(), &dictionary, None)
                .set_details(Some(vec![
                    "名詞".to_string(),
                    "接尾".to_string(),
                    "地域".to_string(),

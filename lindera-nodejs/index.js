  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (bindingPackageVersion !== '5.0.1' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 5.0.1 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
    ...
    try {
      ...
      if (!candidateFailed) {
        if (process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          ...
          if (bindingPackageVersion !== '5.0.1') {
            throw new Error(`WASI binding package version mismatch, expected 5.0.1 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
        }
...
module.exports.JsDictionary = nativeBinding.JsDictionary
module.exports.Metadata = nativeBinding.Metadata
module.exports.JsMetadata = nativeBinding.JsMetadata
module.exports.NbestResult = nativeBinding.NbestResult
module.exports.JsNbestResult = nativeBinding.JsNbestResult
module.exports.Schema = nativeBinding.Schema
module.exports.JsSchema = nativeBinding.JsSchema
module.exports.Token = nativeBinding.Token
module.exports.JsToken = nativeBinding.JsToken
module.exports.Tokenizer = nativeBinding.Tokenizer
module.exports.JsTokenizer = nativeBinding.JsTokenizer
module.exports.TokenizerBuilder = nativeBinding.TokenizerBuilder
module.exports.JsTokenizerBuilder = nativeBinding.JsTokenizerBuilder
module.exports.UserDictionary = nativeBinding.UserDictionary
module.exports.JsUserDictionary = nativeBinding.JsUserDictionary
module.exports.buildDictionary = nativeBinding.buildDictionary
module.exports.buildUserDictionary = nativeBinding.buildUserDictionary
module.exports.exportModel = nativeBinding.exportModel
module.exports.JsFieldType = nativeBinding.JsFieldType
module.exports.JsMode = nativeBinding.JsMode
module.exports.loadDictionary = nativeBinding.loadDictionary
module.exports.loadUserDictionary = nativeBinding.loadUserDictionary
module.exports.train = nativeBinding.train

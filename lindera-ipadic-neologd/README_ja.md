...
このリポジトリには [mecab-ipadic-neologd](https://github.com/lindera-morphology/mecab-ipadic-neologd) が含まれています。

## 辞書フォーマット

IPADIC 辞書のフォーマットと品詞タグの詳細については、[マニュアル](https://ja.osdn.net/projects/ipadic/docs/ipadic-2.7.0-manual-en.pdf/en/1/ipadic-2.7.0-manual-en.pdf.pdf)を参照してください。

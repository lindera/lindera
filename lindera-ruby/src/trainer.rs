...
/// * `max_threads` - Maximum number of threads (nil = auto-detect CPU cores).
...
/// Defines train and export module functions in the given Ruby module.
///
/// # Arguments
///
/// * `_ruby` - Ruby runtime handle.
